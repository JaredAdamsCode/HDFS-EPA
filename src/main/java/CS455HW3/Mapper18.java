...
public class Mapper18 extends Mapper<LongWritable, Text, Text, DoubleWritable>{
...
//	}
	...
	protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException{
		...
		if(delimittedLine.length >= 3) {
			...
			String average = "EC-Average";
			if(valid && (state.equals("23") || state.equals("33") || state.equals("25") || state.equals("44") ||
